...
class UserUrl:
  ...
  def get_user_routes(app):
    ...
    app.add_url_rule("/api/v1/auth/signup", view_func= register_user_view, methods=["POST",])
    app.add_url_rule("/api/v1/auth/login", view_func=login_user_view, methods=["POST",])
